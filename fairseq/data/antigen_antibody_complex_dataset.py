...
def collate(
    ...
    def collate_length(value):
        values = [s[value] for s in samples]
        lengths = torch.IntTensor(values)
        return lengths
    ...
    antigen_length_batch = collate_length("antigen_len").index_select(0, sort_order)
    heavy_chain_length_batch = collate_length("heavy_chain_len").index_select(0, sort_order)
    ...
    batch = {
        ...
        "target": target,
        "center": center_batch,
        "antigen_len": antigen_length_batch,
        "heavy_chain_len": heavy_chain_length_batch
    }
    return batch


class AntigenAntibodyComplexDataset(FairseqDataset):
    """
    ...
    def __getitem__(self, index):
        seq_item, atom_item, coor_item, center_item, target_item, antigen_len_item, heavy_chain_len_item = self.protein_complex[index]
        ...
        example = {
            ...
            "target": target_item,
            "center": center_item,
            "antigen_len": antigen_len_item,
            "heavy_chain_len": heavy_chain_len_item
            }
